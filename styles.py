...
class MinesweeperStyles:
    ...
    def configure_styles(self):
        ...
        self.style.configure('MS_bomb.TButton', background="red", relief='raised', width=2,)
        self.style.configure('MS_pressed.TButton', background="#656565", relief='raised', width=2,)
